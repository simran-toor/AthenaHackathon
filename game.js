var playerGamePiece, teacherGamePiece;
...
function updateGameArea() {
    ...
    if (myGameArea.key && myGameArea.key == 37) {playerGamePiece.speedX = -2; }
    if (myGameArea.key && myGameArea.key == 39) {playerGamePiece.speedX = 2; }
    if (myGameArea.key && myGameArea.key == 38) {playerGamePiece.speedY = -2; }
    if (myGameArea.key && myGameArea.key == 40) {playerGamePiece.speedY = 2; }
